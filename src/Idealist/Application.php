...
use Idealist\Provider\GitServiceProvider;
use Idealist\Provider\RepositoryUtilServiceProvider;
use Idealist\Provider\ViewUtilServiceProvider;
use Idealist\Provider\RoutingUtilServiceProvider;
use Symfony\Component\Filesystem\Filesystem;

/**
 * Idealist application.
 */
class Application extends SilexApplication
{
    ...
    public function __construct(Config $config, $root = null)
    {
        ...
        $this['title'] = $config->get('app', 'title') ? $config->get('app', 'title') : 'Idealist';
